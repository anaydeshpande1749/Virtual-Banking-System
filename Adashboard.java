...
//Rohit password 123 is the admin for this project rest are customers
...
class Adashboard extends JFrame {
    Adashboard() {
        ...
        b1.addActionListener(
                a->
                {  //data ka standard form utf 8
                    tableModel.setRowCount(0); //isse pura table clear hota hai
                    ...
                    {
                        String sql = "select * from users where balance between "+min+" and "+max; //here space between and is imp
        ...
        String url = "";
        //below is a fetching code for data to be displayed
        try (Connection con = DriverManager.getConnection(url, "", ""))
        {
