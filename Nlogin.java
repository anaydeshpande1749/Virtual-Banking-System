                   ...
                   if (t2.getText().equals(t3.getText())) {
                       ...
                       try (Connection con = DriverManager.getConnection(url, "", "")) {
                           ...
                           try (PreparedStatement pst = con.prepareStatement(sql)) {
                               // to insert into table to manipulate table execute update
...
//         int labelX = 200, fieldX = 400, y = 80, gap = 40;
...
//         t2.setBounds(fieldX, y + gap, 150, 30);

//         l3.setBounds(labelX, y + 2 * gap, 150, 30);
//         t3.setBounds(fieldX, y + 2 * gap, 150, 30);

//         l4.setBounds(labelX, y + 3 * gap, 150, 30);
//         t4.setBounds(fieldX, y + 3 * gap, 150, 30);

//         l5.setBounds(labelX, y + 4 * gap, 150, 30);
//         t5.setBounds(fieldX, y + 4 * gap, 150, 30);

//         l6.setBounds(labelX, y + 5 * gap, 150, 30);
//         genderBox.setBounds(fieldX, y + 5 * gap, 150, 30);

//         b1.setBounds(250, y + 6 * gap, 120, 40);
//         b2.setBounds(400, y + 6 * gap, 120, 40);
...
//                         "INSERT INTO users(username,password,balance,phone,email,gender,wlimit) VALUES(?,?,?,?,?,?,?)"
//                 );
